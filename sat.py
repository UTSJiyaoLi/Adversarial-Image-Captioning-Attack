...
def sat(image, encoder=encoder, decoder=decoder, word_map=word_map, beam_size=3):
...
if __name__ == '__main__':
    ...
    files = sorted(files)
    image_path = folder_path + '/' + str(files[18726])
